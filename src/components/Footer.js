    ...
    <div className="container  text-md-left">
      <div className="row  text-md-left">
        <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
          ...
          <svg xmlns="http://www.w3.org/2000/svg"   width={20} height={20} fill="currentColor"className="bi my-bi bi-megaphone-fill" viewBox="0 0 16 16">
        ...
        <hr className="mb-4 " />
          <div className=" d-flex justify-content-between align-items-center  ">
               ...
               <li style={{ marginRight: '15px', display: 'inline-block' }}>Terms of Use</li>
               <li style={{ marginRight: '15px', display: 'inline-block' }}>Privacy & Terms</li>
              </ul>
              
               <p style={{ display: 'inline-block',color :'gray' }}>2023 Websiteica All rights reserved.</p>
